...
[__SOURCE](4-basic-components/3-component-func/2-safety_module_BD632T/README.md)
# 4.3.2. 안전IO보드(BD632T)

[__SOURCE](4-basic-components/3-component-func/2-safety_module_BD632T/1-overview.md)
# 4.3.2.1. 개요
...
[__SOURCE](4-basic-components/3-component-func/2-safety_module_BD632T/2-connector.md)
# 4.3.2.2. 커넥터
...
[__SOURCE](4-basic-components/3-component-func/2-safety_module_BD632T/3-display.md)
# 4.3.2.3. 표시장치
...
[__SOURCE](4-basic-components/3-component-func/2-safety_module_BD632T/4-setting-device.md)
# 4.3.2.4. 설정장치
...
[__SOURCE](4-basic-components/3-component-func/2-safety_module_BD632T/5-em-stop-conn.md)
# 4.3.2.5. 비상정지의 연결
...
[__SOURCE](4-basic-components/3-component-func/2-safety_module_BD632T/6-safety-guard-conn.md)
# 4.3.2.6. 안전가드의 연결
...
[__SOURCE](4-basic-components/3-component-func/2-safety_module_BD632T/7-safety-plc-io-conn.md)
...
[__SOURCE](4-basic-components/3-component-func/2-safety_module_BD632T/8-ext-motor-on-sig-conn.md)
...
[__SOURCE](4-basic-components/3-component-func/3-servo_control_board_BD641T/README.md)
# 4.3.3. 서보제어보드(BD641T)

[__SOURCE](4-basic-components/3-component-func/3-servo_control_board_BD641T/1-overview.md)
# 4.3.3.1. 개요
...
[__SOURCE](4-basic-components/3-component-func/3-servo_control_board_BD641T/2-connector.md)
# 4.3.3.2. 커넥터
...
[__SOURCE](4-basic-components/3-component-func/3-servo_control_board_BD641T/3-display.md)
# 4.3.3.3. 표시장치
...
[__SOURCE](4-basic-components/3-component-func/3-servo_control_board_BD641T/4-setting-device.md)
# 4.3.3.4. 설정장치
...
[__SOURCE](4-basic-components/3-component-func/7-teach_pendant_TP630/README.md)
# 4.3.7. 티치펜던트 (TP630)

[__SOURCE](4-basic-components/3-component-func/7-teach_pendant_TP630/1-overview.md)
# 4.3.7.1. 개요
...
[__SOURCE](4-basic-components/3-component-func/7-teach_pendant_TP630/2-USB-cover.md)
# 4.3.7.2. USB 커버
